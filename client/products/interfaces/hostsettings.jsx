...
console.log(err);
    ...
    function changepassword() {
        ...
        try {
            let response = axios.post(`${import.meta.env.VITE_BACKEND_URL}/hosts/changepassword`, obj, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            })
    ...
    function changecred() {
        ...
        try {
            let response = axios.post(`${import.meta.env.VITE_BACKEND_URL}/hosts/changecred`, obj, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            })
    ...
    return (
        <div className='h-screen w-screen'>
            <div className='h-screen w-screen flex'>
                <Hostsidebar name={host.name} email={host.email}></Hostsidebar>
